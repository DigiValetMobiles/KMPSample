...
@class SharedKoin_coreKoin, SharedCountriesRepository, SharedMuseumRepository, SharedMuseumObject, SharedKtor_client_coreHttpClient, SharedKtorMuseumApiCompanion, SharedMuseumObjectCompanion, SharedApollo_apiCompiledField, SharedApollo_apiCustomScalarAdapters, SharedContinentsQueryCompanion, SharedContinentsQueryContinent, SharedContinentsQueryCountry, SharedContinentsQueryData, SharedContinentsQuery_ResponseAdapter, SharedContinentsQuery_ResponseAdapterContinent, SharedContinentsQuery_ResponseAdapterCountry, SharedContinentsQuery_ResponseAdapterData, SharedContinentsQuerySelections, SharedApollo_apiCompiledSelection, SharedContinentCompanion, SharedApollo_apiObjectType, SharedCountryCompanion, SharedGraphQLBooleanCompanion, SharedApollo_apiCustomScalarType, SharedGraphQLFloatCompanion, SharedGraphQLIDCompanion, SharedGraphQLIntCompanion, SharedGraphQLStringCompanion, SharedQueryCompanion, SharedHttpError, SharedKotlinException, SharedHttpErrorAPOLLO_EXCEPTION, SharedHttpErrorCODE_MISSING, SharedHttpErrorINTERNET_CONNECTION, SharedHttpErrorUNAUTHORIZED, SharedHttpErrorUNKNOWN, SharedStatesError, SharedStatesIdle, SharedStatesLoading, SharedStatesSuccess<__covariant T>, SharedKoin_coreModule, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreLogger, SharedKoin_coreExtensionManager, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKtor_client_coreHttpClientEngineConfig, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_eventsEvents, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedApollo_apiExecutableVariables, SharedApollo_apiCompiledFieldBuilder, SharedApollo_apiCompiledArgument, SharedApollo_apiCompiledCondition, SharedApollo_apiCompiledType, SharedApollo_apiJsonNumber, SharedApollo_apiCustomScalarAdaptersKey, SharedApollo_apiCustomScalarAdaptersBuilder, SharedApollo_apiAdapterContext, SharedKotlinNothing, SharedApollo_apiJsonReaderToken, SharedApollo_apiCompiledNamedType, SharedApollo_apiInterfaceType, SharedApollo_apiObjectTypeBuilder, SharedKoin_coreKoinDefinition<R>, SharedKoin_coreInstanceFactory<T>, SharedKoin_coreSingleInstanceFactory<T>, SharedKoin_coreScopeDSL, SharedKoin_coreLockable, SharedStately_concurrencyThreadLocalRef<T>, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKoin_coreLevel, SharedKoin_coreScopeRegistryCompanion, SharedKtor_client_coreHttpRequestData, SharedKtor_client_coreHttpResponseData, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKtor_client_coreProxyConfig, SharedKtor_utilsAttributeKey<T>, SharedKtor_eventsEventDefinition<T>, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpResponse, SharedKotlinUnit, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpClientCall, SharedKtor_client_coreHttpSendPipelinePhases, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedApollo_apiAdapterContextBuilder, SharedApollo_apiInterfaceTypeBuilder, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKtor_httpUrl, SharedKtor_httpHttpMethod, SharedKtor_httpOutgoingContent, SharedKtor_httpHttpStatusCode, SharedKtor_utilsGMTDate, SharedKtor_httpHttpProtocolVersion, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_httpURLBuilder, SharedKtor_utilsTypeInfo, SharedKtor_client_coreHttpClientCallCompanion, SharedKotlinByteArray, SharedOkioByteString, SharedOkioBuffer, SharedOkioTimeout, SharedApollo_apiCustomTypeValue<T>, SharedApollo_apiDeferredFragmentIdentifier, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKtor_httpUrlCompanion, SharedKtor_httpURLProtocol, SharedKtor_httpHttpMethodCompanion, SharedKtor_httpContentType, SharedKotlinCancellationException, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpProtocolVersionCompanion, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKtor_ioMemory, SharedKtor_ioChunkBuffer, SharedKtor_ioBuffer, SharedKtor_ioByteReadPacket, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_httpURLBuilderCompanion, SharedKotlinByteIterator, SharedOkioByteStringCompanion, SharedOkioBufferUnsafeCursor, SharedOkioTimeoutCompanion, SharedApollo_apiCustomTypeValueCompanion, SharedKtor_httpURLProtocolCompanion, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentTypeCompanion, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioChunkBufferCompanion, SharedKtor_ioInputCompanion, SharedKtor_ioInput, SharedKtor_ioByteReadPacketCompanion, SharedKotlinKTypeProjection, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion;

@protocol SharedKoin_coreKoinComponent, SharedKotlinx_coroutines_coreFlow, SharedMuseumStorage, SharedMuseumApi, SharedKotlinx_serialization_coreKSerializer, SharedApollo_apiAdapter, SharedApollo_apiJsonWriter, SharedApollo_apiExecutable, SharedApollo_apiOperation, SharedApollo_apiQuery, SharedApollo_apiExecutableData, SharedApollo_apiOperationData, SharedApollo_apiQueryData, SharedStates, SharedApollo_apiJsonReader, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKotlinKClass, SharedKotlinLazy, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreCoroutineScope, SharedKtor_ioCloseable, SharedKtor_client_coreHttpClientEngine, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_utilsAttributes, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedApollo_apiUpload, SharedOkioCloseable, SharedApollo_apiExecutionContextKey, SharedApollo_apiExecutionContextElement, SharedApollo_apiExecutionContext, SharedKoin_coreScopeCallback, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinComparable, SharedKoin_coreKoinExtension, SharedKotlinIterator, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKtor_client_coreHttpClientPlugin, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSuspendFunction2, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedOkioBufferedSink, SharedApollo_apiCustomTypeAdapter, SharedKtor_httpHeaders, SharedKotlinx_coroutines_coreJob, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedKotlinFunction, SharedKtor_httpHttpMessage, SharedKtor_ioByteReadChannel, SharedKtor_httpHttpMessageBuilder, SharedKtor_client_coreHttpRequest, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedOkioSource, SharedOkioSink, SharedKtor_httpParameters, SharedKotlinMapEntry, SharedKtor_utilsStringValues, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParametersBuilder, SharedKotlinKType, SharedOkioBufferedSource, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinx_coroutines_coreSelectClause, SharedKtor_ioObjectPool;
...
__attribute__((swift_name("KoinDependencies")))
@interface SharedKoinDependencies : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (readonly) SharedCountriesRepository *countriesRepository __attribute__((swift_name("countriesRepository")));
@property (readonly) SharedMuseumRepository *museumRepository __attribute__((swift_name("museumRepository")));
@end

__attribute__((swift_name("MuseumStorage")))
@protocol SharedMuseumStorage
@required
- (id<SharedKotlinx_coroutines_coreFlow>)getObjectByIdObjectId:(int32_t)objectId __attribute__((swift_name("getObjectById(objectId:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjects __attribute__((swift_name("getObjects()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveObjectsNewObjects:(NSArray<SharedMuseumObject *> *)newObjects completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("saveObjects(newObjects:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InMemoryMuseumStorage")))
@interface SharedInMemoryMuseumStorage : SharedBase <SharedMuseumStorage>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjectByIdObjectId:(int32_t)objectId __attribute__((swift_name("getObjectById(objectId:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjects __attribute__((swift_name("getObjects()")));
...
__attribute__((swift_name("MuseumApi")))
@protocol SharedMuseumApi
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getDataWithCompletionHandler:(void (^)(NSArray<SharedMuseumObject *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getData(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KtorMuseumApi")))
@interface SharedKtorMuseumApi : SharedBase <SharedMuseumApi>
...
@property (class, readonly, getter=companion) SharedKtorMuseumApiCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KtorMuseumApi.Companion")))
@interface SharedKtorMuseumApiCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedKtorMuseumApiCompanion *shared __attribute__((swift_name("shared")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MuseumObject")))
@interface SharedMuseumObject : SharedBase
- (instancetype)initWithObjectID:(int32_t)objectID title:(NSString *)title artistDisplayName:(NSString *)artistDisplayName medium:(NSString *)medium dimensions:(NSString *)dimensions objectURL:(NSString *)objectURL objectDate:(NSString *)objectDate primaryImage:(NSString *)primaryImage primaryImageSmall:(NSString *)primaryImageSmall repository:(NSString *)repository department:(NSString *)department creditLine:(NSString *)creditLine __attribute__((swift_name("init(objectID:title:artistDisplayName:medium:dimensions:objectURL:objectDate:primaryImage:primaryImageSmall:repository:department:creditLine:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedMuseumObjectCompanion *companion __attribute__((swift_name("companion")));
- (SharedMuseumObject *)doCopyObjectID:(int32_t)objectID title:(NSString *)title artistDisplayName:(NSString *)artistDisplayName medium:(NSString *)medium dimensions:(NSString *)dimensions objectURL:(NSString *)objectURL objectDate:(NSString *)objectDate primaryImage:(NSString *)primaryImage primaryImageSmall:(NSString *)primaryImageSmall repository:(NSString *)repository department:(NSString *)department creditLine:(NSString *)creditLine __attribute__((swift_name("doCopy(objectID:title:artistDisplayName:medium:dimensions:objectURL:objectDate:primaryImage:primaryImageSmall:repository:department:creditLine:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *artistDisplayName __attribute__((swift_name("artistDisplayName")));
@property (readonly) NSString *creditLine __attribute__((swift_name("creditLine")));
...
@property (readonly) NSString *objectDate __attribute__((swift_name("objectDate")));
@property (readonly) int32_t objectID __attribute__((swift_name("objectID")));
@property (readonly) NSString *objectURL __attribute__((swift_name("objectURL")));
@property (readonly) NSString *primaryImage __attribute__((swift_name("primaryImage")));
@property (readonly) NSString *primaryImageSmall __attribute__((swift_name("primaryImageSmall")));
@property (readonly) NSString *repository __attribute__((swift_name("repository")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MuseumObject.Companion")))
@interface SharedMuseumObjectCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMuseumObjectCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MuseumRepository")))
@interface SharedMuseumRepository : SharedBase
- (instancetype)initWithMuseumApi:(id<SharedMuseumApi>)museumApi museumStorage:(id<SharedMuseumStorage>)museumStorage __attribute__((swift_name("init(museumApi:museumStorage:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjectByIdObjectId:(int32_t)objectId __attribute__((swift_name("getObjectById(objectId:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjects __attribute__((swift_name("getObjects()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery")))
@interface SharedContinentsQuery : SharedBase <SharedApollo_apiQuery>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedContinentsQueryCompanion *companion __attribute__((swift_name("companion")));
- (id<SharedApollo_apiAdapter>)adapter __attribute__((swift_name("adapter()")));
- (NSString *)document __attribute__((swift_name("document()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery.Companion")))
@interface SharedContinentsQueryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedContinentsQueryCompanion *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery.Continent")))
@interface SharedContinentsQueryContinent : SharedBase
- (instancetype)initWithCode:(NSString * _Nullable)code countries:(NSArray<id> * _Nullable)countries name:(NSString * _Nullable)name __attribute__((swift_name("init(code:countries:name:)"))) __attribute__((objc_designated_initializer));
- (SharedContinentsQueryContinent *)doCopyCode:(NSString * _Nullable)code countries:(NSArray<id> * _Nullable)countries name:(NSString * _Nullable)name __attribute__((swift_name("doCopy(code:countries:name:)")));
- (NSArray<SharedContinentsQueryCountry *> * _Nullable)countriesFilterNotNull __attribute__((swift_name("countriesFilterNotNull()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery.Country")))
@interface SharedContinentsQueryCountry : SharedBase
- (instancetype)initWithCode:(NSString * _Nullable)code name:(NSString * _Nullable)name native:(NSString * _Nullable)native phone:(NSString * _Nullable)phone __attribute__((swift_name("init(code:name:native:phone:)"))) __attribute__((objc_designated_initializer));
- (SharedContinentsQueryCountry *)doCopyCode:(NSString * _Nullable)code name:(NSString * _Nullable)name native:(NSString * _Nullable)native phone:(NSString * _Nullable)phone __attribute__((swift_name("doCopy(code:name:native:phone:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable code __attribute__((swift_name("code")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery.Data")))
@interface SharedContinentsQueryData : SharedBase <SharedApollo_apiQueryData>
- (instancetype)initWithContinents:(NSArray<id> * _Nullable)continents __attribute__((swift_name("init(continents:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedContinentsQueryContinent *> * _Nullable)continentsFilterNotNull __attribute__((swift_name("continentsFilterNotNull()")));
- (SharedContinentsQueryData *)doCopyContinents:(NSArray<id> * _Nullable)continents __attribute__((swift_name("doCopy(continents:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<id> * _Nullable continents __attribute__((swift_name("continents")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CountriesRepository")))
@interface SharedCountriesRepository : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getContinentsWithCompletionHandler:(void (^)(id<SharedStates> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getContinents(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getCountriesWithCompletionHandler:(void (^)(id<SharedStates> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getCountries(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery_ResponseAdapter")))
@interface SharedContinentsQuery_ResponseAdapter : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)continentsQuery_ResponseAdapter __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedContinentsQuery_ResponseAdapter *shared __attribute__((swift_name("shared")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery_ResponseAdapter.Continent")))
@interface SharedContinentsQuery_ResponseAdapterContinent : SharedBase <SharedApollo_apiAdapter>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)continent __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedContinentsQuery_ResponseAdapterContinent *shared __attribute__((swift_name("shared")));

/**
 * @note This method converts instances of IOException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (SharedContinentsQueryContinent * _Nullable)fromJsonReader:(id<SharedApollo_apiJsonReader>)reader customScalarAdapters:(SharedApollo_apiCustomScalarAdapters *)customScalarAdapters error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("fromJson(reader:customScalarAdapters:)"))) __attribute__((swift_error(nonnull_error)));

/**
 * @note This method converts instances of IOException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)toJsonWriter:(id<SharedApollo_apiJsonWriter>)writer customScalarAdapters:(SharedApollo_apiCustomScalarAdapters *)customScalarAdapters value:(SharedContinentsQueryContinent *)value error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("toJson(writer:customScalarAdapters:value:)")));
@property (readonly) NSArray<NSString *> *RESPONSE_NAMES __attribute__((swift_name("RESPONSE_NAMES")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery_ResponseAdapter.Country")))
@interface SharedContinentsQuery_ResponseAdapterCountry : SharedBase <SharedApollo_apiAdapter>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)country __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedContinentsQuery_ResponseAdapterCountry *shared __attribute__((swift_name("shared")));

/**
 * @note This method converts instances of IOException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (SharedContinentsQueryCountry * _Nullable)fromJsonReader:(id<SharedApollo_apiJsonReader>)reader customScalarAdapters:(SharedApollo_apiCustomScalarAdapters *)customScalarAdapters error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("fromJson(reader:customScalarAdapters:)"))) __attribute__((swift_error(nonnull_error)));

/**
 * @note This method converts instances of IOException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)toJsonWriter:(id<SharedApollo_apiJsonWriter>)writer customScalarAdapters:(SharedApollo_apiCustomScalarAdapters *)customScalarAdapters value:(SharedContinentsQueryCountry *)value error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("toJson(writer:customScalarAdapters:value:)")));
@property (readonly) NSArray<NSString *> *RESPONSE_NAMES __attribute__((swift_name("RESPONSE_NAMES")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuery_ResponseAdapter.Data")))
@interface SharedContinentsQuery_ResponseAdapterData : SharedBase <SharedApollo_apiAdapter>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)data __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedContinentsQuery_ResponseAdapterData *shared __attribute__((swift_name("shared")));

/**
 * @note This method converts instances of IOException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (SharedContinentsQueryData * _Nullable)fromJsonReader:(id<SharedApollo_apiJsonReader>)reader customScalarAdapters:(SharedApollo_apiCustomScalarAdapters *)customScalarAdapters error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("fromJson(reader:customScalarAdapters:)"))) __attribute__((swift_error(nonnull_error)));

/**
 * @note This method converts instances of IOException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)toJsonWriter:(id<SharedApollo_apiJsonWriter>)writer customScalarAdapters:(SharedApollo_apiCustomScalarAdapters *)customScalarAdapters value:(SharedContinentsQueryData *)value error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("toJson(writer:customScalarAdapters:value:)")));
@property (readonly) NSArray<NSString *> *RESPONSE_NAMES __attribute__((swift_name("RESPONSE_NAMES")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContinentsQuerySelections")))
@interface SharedContinentsQuerySelections : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)continentsQuerySelections __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedContinentsQuerySelections *shared __attribute__((swift_name("shared")));
@property (readonly) NSArray<SharedApollo_apiCompiledSelection *> *__root __attribute__((swift_name("__root")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Continent")))
@interface SharedContinent : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedContinentCompanion *companion __attribute__((swift_name("companion")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Continent.Companion")))
@interface SharedContinentCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedContinentCompanion *shared __attribute__((swift_name("shared")));
...
__attribute__((swift_name("HttpError")))
@interface SharedHttpError : SharedBase
- (NSString *)getErrorMessage __attribute__((swift_name("getErrorMessage()")));
- (SharedHttpError *)handleErrorCodeCode:(int32_t)code __attribute__((swift_name("handleErrorCode(code:)")));
- (SharedHttpError *)handleExceptionException:(SharedKotlinException *)exception __attribute__((swift_name("handleException(exception:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpError.APOLLO_EXCEPTION")))
@interface SharedHttpErrorAPOLLO_EXCEPTION : SharedHttpError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)aPOLLO_EXCEPTION __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHttpErrorAPOLLO_EXCEPTION *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpError.CODE_MISSING")))
@interface SharedHttpErrorCODE_MISSING : SharedHttpError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)cODE_MISSING __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHttpErrorCODE_MISSING *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpError.INTERNET_CONNECTION")))
@interface SharedHttpErrorINTERNET_CONNECTION : SharedHttpError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)iNTERNET_CONNECTION __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHttpErrorINTERNET_CONNECTION *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpError.UNAUTHORIZED")))
@interface SharedHttpErrorUNAUTHORIZED : SharedHttpError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)uNAUTHORIZED __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHttpErrorUNAUTHORIZED *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpError.UNKNOWN")))
@interface SharedHttpErrorUNKNOWN : SharedHttpError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)uNKNOWN __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHttpErrorUNKNOWN *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@protocol SharedStates
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StatesError")))
@interface SharedStatesError : SharedBase <SharedStates>
- (instancetype)initWithError:(SharedHttpError *)error __attribute__((swift_name("init(error:)"))) __attribute__((objc_designated_initializer));
- (SharedStatesError *)doCopyError:(SharedHttpError *)error __attribute__((swift_name("doCopy(error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedHttpError *error __attribute__((swift_name("error")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StatesIdle")))
@interface SharedStatesIdle : SharedBase <SharedStates>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)idle __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedStatesIdle *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StatesLoading")))
@interface SharedStatesLoading : SharedBase <SharedStates>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)loading __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedStatesLoading *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StatesSuccess")))
@interface SharedStatesSuccess<__covariant T> : SharedBase <SharedStates>
- (instancetype)initWithData:(T _Nullable)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
- (SharedStatesSuccess<T> *)doCopyData:(T _Nullable)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
+ (void)doInitKoinExtraModules:(NSArray<SharedKoin_coreModule *> *)extraModules __attribute__((swift_name("doInitKoin(extraModules:)")));
...
- (id)getKey__:(SharedKtor_utilsAttributeKey<id> *)key __attribute__((swift_name("get(key__:)")));
...
@property (readonly) SharedLong * _Nullable contentLength_ __attribute__((swift_name("contentLength_")));
